# -*- coding: utf-8 -*-
"""Create compound embeddings for the experimental Ms datasets.

Reads from preprocessed_data/:
    Experimental_Ms_RE-Free.csv
    Experimental_Ms_RE.csv
    Experimental_Ms_all.csv

Saves to outputs/:
    Experimental_Ms_RE-Free_w_embeddings.pkl
    Experimental_Ms_RE_w_embeddings.pkl
    Experimental_Ms_all_w_embeddings.pkl

Each output pickle contains the original columns (composition, Ms) plus a
...
TARGET = "Ms"   # experimental saturation magnetisation [A/m]

DATASETS = [
    {
        "name": "RE-Free",
        "csv":  "Experimental_Ms_RE-Free.csv",
        "out":  "Experimental_Ms_RE-Free_w_embeddings.pkl",
    },
    {
        "name": "RE",
        "csv":  "Experimental_Ms_RE.csv",
        "out":  "Experimental_Ms_RE_w_embeddings.pkl",
    },
    {
        "name": "All",
        "csv":  "Experimental_Ms_all.csv",
        "out":  "Experimental_Ms_all_w_embeddings.pkl",
    },
]
...
def create_embeddings() -> None:
    print("=" * 70)
    print("Creating compound embeddings for experimental Ms datasets")
    print("=" * 70)
