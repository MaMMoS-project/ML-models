# -*- coding: utf-8 -*-
"""Create compound embeddings for the simulated Ms datasets.

Reads from preprocessed_data/:
    Simulated_Ms_RE-Free.csv
    Simulated_Ms_RE.csv
    Simulated_Ms_all.csv

Saves to outputs/:
    Simulated_Ms_RE-Free_w_embeddings.pkl
    Simulated_Ms_RE_w_embeddings.pkl
    Simulated_Ms_all_w_embeddings.pkl
...
TARGET = "Ms"   # simulated saturation magnetisation [A/m]

DATASETS = [
    {
        "name": "RE-Free",
        "csv":  "Simulated_Ms_RE-Free.csv",
        "out":  "Simulated_Ms_RE-Free_w_embeddings.pkl",
    },
    {
        "name": "RE",
        "csv":  "Simulated_Ms_RE.csv",
        "out":  "Simulated_Ms_RE_w_embeddings.pkl",
    },
    {
        "name": "All",
        "csv":  "Simulated_Ms_all.csv",
        "out":  "Simulated_Ms_all_w_embeddings.pkl",
    },
]
...
def create_embeddings() -> None:
    print("=" * 70)
    print("Creating compound embeddings for simulated Ms datasets")
    print("=" * 70)
