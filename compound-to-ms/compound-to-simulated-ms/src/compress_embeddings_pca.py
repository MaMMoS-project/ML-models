# -*- coding: utf-8 -*-
"""Compress compound embeddings with PCA for the simulated Ms datasets.
...
DATASETS = [
    {
        "name": "RE-Free",
        "in":  "Simulated_Ms_RE-Free_w_embeddings.pkl",
        "out": "Simulated_Ms_RE-Free_w_embeddings_PCA.pkl",
    },
    {
        "name": "RE",
        "in":  "Simulated_Ms_RE_w_embeddings.pkl",
        "out": "Simulated_Ms_RE_w_embeddings_PCA.pkl",
    },
    {
        "name": "All",
        "in":  "Simulated_Ms_all_w_embeddings.pkl",
        "out": "Simulated_Ms_all_w_embeddings_PCA.pkl",
    },
]
...
def compress_embeddings_pca() -> None:
    ...
    print("\nDone. Next step: python src/train_ms.py")
