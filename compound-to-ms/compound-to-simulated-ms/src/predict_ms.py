#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Predict saturation magnetisation (Ms, simulated) for a new compound using a trained ONNX model.
...
BEST_CSV     = PROJECT_ROOT / "results" / "sim_ms_best_by_dataset.csv"
...
def _load_best_model_tags() -> "dict[str, str]":
    """Return {onnx_base_name: 'best for <Dataset>'} from sim_ms_best_by_dataset.csv.
