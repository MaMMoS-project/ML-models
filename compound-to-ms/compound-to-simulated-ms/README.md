...
- TODO: also include other models in this table!

| Embedding | Model |       R² (mean ± std) |      MAE (mean ± std) |     RMSE (mean ± std) |     MAE_Am (mean ± std) | MedRelErr (mean ± std) |
| --------- | ----- | --------------------: | --------------------: | --------------------: | ----------------------: | ---------------------: |
| raw_200D  | LGBM  | 0.755 ± 0.009           | 0.282 ± 0.004           | 0.395 ± 0.006           | 69428.83 ± 1354.69       | 0.195 ± 0.004           |
| raw_200D  | RF    | 0.696 ± 0.011           | 0.327 ± 0.006           | 0.438 ± 0.007           | 80839.91 ± 1653.07       | 0.240 ± 0.004           |
| pca_64    | LGBM  | 0.731 ± 0.008           | 0.303 ± 0.005           | 0.412 ± 0.007           | 74759.30 ± 1662.31       | 0.215 ± 0.003           |
| pca_64    | RF    | 0.658 ± 0.010           | 0.351 ± 0.005           | 0.466 ± 0.007           | 87691.99 ± 1328.31       | 0.256 ± 0.005           |
| pca_32    | LGBM  | 0.714 ± 0.009           | 0.315 ± 0.006           | 0.425 ± 0.008           | 77942.06 ± 1137.48       | 0.228 ± 0.007           |
| pca_32    | RF    | 0.662 ± 0.008           | 0.358 ± 0.005           | 0.463 ± 0.006           | 90157.60 ± 1494.67       | 0.273 ± 0.005           |
| pca_16    | LGBM  | 0.670 ± 0.011           | 0.347 ± 0.005           | 0.458 ± 0.006           | 85984.04 ± 1312.97       | 0.260 ± 0.005           |
| pca_16    | RF    | 0.645 ± 0.008           | 0.365 ± 0.005           | 0.474 ± 0.005           | 91328.41 ± 1283.73       | 0.278 ± 0.004           |
| pca_8     | LGBM  | 0.557 ± 0.012           | 0.411 ± 0.005           | 0.530 ± 0.004           | 105319.96 ± 1943.97      | 0.309 ± 0.005           |
| pca_8     | RF    | 0.562 ± 0.015           | 0.404 ± 0.006           | 0.528 ± 0.007           | 103217.90 ± 1827.81      | 0.302 ± 0.006           |
