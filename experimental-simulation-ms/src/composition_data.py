...
# adapted from: https://gitlab.mpcdf.mpg.de/mpcdf-dataanalytics/aviary/-/blob/main/aviary/roost/data.py?ref_type=heads; 2ed6dd41f922be66fd887862b3769f1b9b0fb684
...
class CompositionData(Dataset):   
    ...
    def __init__(
        ...
        #     elem_embedding = f"{PKG_DIR}/embeddings/element/{elem_embedding}.json"
            elem_embedding = f"../embeddings/element/{elem_embedding}.json"
