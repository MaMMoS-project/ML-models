# -*- coding: utf-8 -*-
"""Train models to predict experimental Tc — RE-Free dataset.

Run in order:

    python src/create_embeddings.py
    python src/compress_embeddings_pca.py
    python src/train_exp_tc_re_free.py

Input file (outputs/):
    Experimental_Tc_RE-Free_w_embeddings_PCA.pkl

Outputs:
    results/exp_tc/RE-Free_results.csv
    ...
    results/exp_tc/figures/RE-Free_*.png
...
@log_output("logs/train_exp_tc_re_free.txt")
def main() -> None:
    print("=" * 70)
