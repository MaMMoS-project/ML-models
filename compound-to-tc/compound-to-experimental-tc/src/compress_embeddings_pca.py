# -*- coding: utf-8 -*-
"""Compress compound embeddings with PCA for the experimental Tc datasets.
...
DATASETS = [
    {
        "name": "RE-Free",
        "in":  "Experimental_Tc_RE-Free_w_embeddings.pkl",
        "out": "Experimental_Tc_RE-Free_w_embeddings_PCA.pkl",
    },
    {
        "name": "RE",
        "in":  "Experimental_Tc_RE_w_embeddings.pkl",
        "out": "Experimental_Tc_RE_w_embeddings_PCA.pkl",
    },
    {
        "name": "All",
        "in":  "Experimental_Tc_all_w_embeddings.pkl",
        "out": "Experimental_Tc_all_w_embeddings_PCA.pkl",
    },
]
