...
def analyze_magnetic_data(data_path=None, plots_dir=None):
    ...
    ###df_filtered2 = df_filtered[df_filtered['Hc (A/m)'] >= 1e8]  
    ...
    print("\n==========================================================\n")
    print("\nPerforming clustering analysis for INVALID inputs...")
    df_invalid = invalid_clustering(df_with_nans, save_path=plots_dir)
    print("\nValid clustering results:")
    print("Number of valid magnets: ", (df_invalid['Valid_Inputs'] == 1).sum())
