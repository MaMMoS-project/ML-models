"""
LightGBM (gradient-boosted trees) Training.
...
Random Forest and is well regularised on small data. Like the other trainers it
operates in log1p space; with delta-learning the target is the correction and is
reconstructed before metrics. Rare-earth physics features are added automatically
when the loader has use_re_features=True.
"""
import os
import numpy as np
import pandas as pd
